...
public class TowerDimen {
    ...
    public static void init(int width, int height) {
        ...
        int txt_size = GRID_SIZE * 8 / 10;
        
        R_PLR_ICON = RectUtil.createRect(TOWER_LEFT, TOWER_TOP - GRID_SIZE / 2 - (txt_size + txt_margin) * 5, txt_size, txt_size);
        R_PLR_LV_V = RectUtil.createRect(R_PLR_ICON.right, R_PLR_ICON.top, GRID_SIZE * 2, txt_size);
        R_PLR_LV_L = RectUtil.createRect(R_PLR_LV_V.right, R_PLR_LV_V.top, txt_size, txt_size);

        R_YKEY_ICON = RectUtil.createRect(TOWER_LEFT, R_PLR_ICON.bottom + txt_margin, txt_size, txt_size);
        R_YKEY_V = RectUtil.createRect(R_YKEY_ICON.right, R_YKEY_ICON.top, GRID_SIZE * 2, txt_size);
        R_YKEY_L = RectUtil.createRect(R_YKEY_V.right, R_YKEY_V.top, txt_size, txt_size);
        
        R_BKEY_ICON = RectUtil.createRect(TOWER_LEFT, R_YKEY_ICON.bottom + txt_margin, txt_size, txt_size);
        R_BKEY_V = RectUtil.createRect(R_BKEY_ICON.right, R_BKEY_ICON.top, GRID_SIZE * 2, txt_size);
        R_BKEY_L = RectUtil.createRect(R_BKEY_V.right, R_BKEY_V.top, txt_size, txt_size);
        
        R_RKEY_ICON = RectUtil.createRect(TOWER_LEFT, R_BKEY_ICON.bottom + txt_margin, txt_size, txt_size);
        R_RKEY_V = RectUtil.createRect(R_RKEY_ICON.right, R_RKEY_ICON.top, GRID_SIZE * 2, txt_size);
        R_RKEY_L = RectUtil.createRect(R_RKEY_V.right, R_RKEY_V.top, txt_size, txt_size);

        R_FLOOR_S = RectUtil.createRect(TOWER_LEFT, R_RKEY_ICON.bottom + txt_margin, txt_size, txt_size);
        R_FLOOR_V = RectUtil.createRect(R_FLOOR_S.right, R_FLOOR_S.top, GRID_SIZE * 2, txt_size);
        R_FLOOR_L = RectUtil.createRect(R_FLOOR_V.right, R_FLOOR_V.top, txt_size, txt_size);
        
        int txt_left = R_TOWER.right - txt_size * 2 - GRID_SIZE * 2;
        
        R_PLR_HP_L = RectUtil.createRect(txt_left, TOWER_TOP - GRID_SIZE / 2 - (txt_size + txt_margin) * 5, txt_size * 2, txt_size);
        R_PLR_HP_V = RectUtil.createRect(R_PLR_HP_L.right, R_PLR_HP_L.top, GRID_SIZE * 2, txt_size);
        R_PLR_ATTACK_L = RectUtil.createRect(txt_left, R_PLR_HP_L.bottom + txt_margin, txt_size * 2, txt_size);
        R_PLR_ATTACK_V = RectUtil.createRect(R_PLR_ATTACK_L.right, R_PLR_ATTACK_L.top, GRID_SIZE * 2, txt_size);
        R_PLR_DEFEND_L = RectUtil.createRect(txt_left, R_PLR_ATTACK_L.bottom + txt_margin, txt_size * 2, txt_size);
        R_PLR_DEFEND_V = RectUtil.createRect(R_PLR_DEFEND_L.right, R_PLR_DEFEND_L.top, GRID_SIZE * 2, txt_size);
        R_PLR_MONEY_L = RectUtil.createRect(txt_left, R_PLR_DEFEND_L.bottom + txt_margin, txt_size * 2, txt_size);
        R_PLR_MONEY_V = RectUtil.createRect(R_PLR_MONEY_L.right, R_PLR_MONEY_L.top, GRID_SIZE * 2, txt_size);
        R_PLR_EXP_L = RectUtil.createRect(txt_left, R_PLR_MONEY_L.bottom + txt_margin, txt_size * 2, txt_size);
        R_PLR_EXP_V = RectUtil.createRect(R_PLR_EXP_L.right, R_PLR_EXP_L.top, GRID_SIZE * 2, txt_size);
