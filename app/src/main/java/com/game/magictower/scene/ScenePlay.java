...
public class ScenePlay extends BaseScene {
    ...
    private final Rect[][] mPathRects;
    
    private final AStarPath astarPath;
    
    private final GridFilter gridFilter = new GridFilter();
    
    private final Point touchPoint = new Point();
    private final Point targetPoint = new Point();
    private final ArrayList<AStarPoint> stepList = new ArrayList<>();
    ...
    private final Handler handler = new PlayHandler(new WeakReference<>(this));
    ...
    private static final class PlayHandler extends Handler {
        private final WeakReference<ScenePlay> wk;
