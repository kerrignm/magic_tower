...
public class SceneForecast extends BaseScene {
    ...
    private final HashSet<Integer> mForecastSet = new HashSet<>();
    private Object[] mIds;
    private final String[] mHPs;
    private final String[] mAttacks;
    private final String[] mDefends;
    private final String[] mMoneys;
    private final String[] mLoses;
    private final Rect[][] mRects;
    
    private final String mName;
    private final String mHP;
    private final String mAttack;
    private final String mDefend;
    private final String mMoney;
    private final String mLose;
    ...
    public static String forecast(Player player, Monster monster) {
        if (player.getAttack() <= monster.getDefend()) {
            ...
            int lose = 0;
            if (monster.getMagicDamage() > 10) {
                lose = monster.getMagicDamage();
            } else if (monster.getMagicDamage() > 0) {
