...
public class SceneJump extends BaseScene {
    ...
    private final Rect[][] mFloorRect;
    private final Rect[][] mEdgeRect;
    private final String[][] mFloorName;
    private int mSelected;
    private final Point mTouchPoint = new Point();
    private final Rect mTouchRect = new Rect(TowerDimen.R_JUMP.left + TowerDimen.GRID_SIZE / 2, TowerDimen.R_JUMP.top + TowerDimen.GRID_SIZE / 2,
