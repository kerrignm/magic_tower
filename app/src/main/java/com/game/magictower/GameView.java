...
public class GameView extends RedrawableView {
    ...
    private final ArrayList<BaseView> mChildrens = new ArrayList<>();
    
    private final GameGraphics graphics;
    
    private boolean isToastShowing = false;
    private String mMsg;
    private final Rect mMsgBgd;
    
    private final ScenePlay scenePlay;
    private final SceneBattle sceneBattle;
    private final SceneShop sceneShop;
    private final SceneMessage sceneMessage;
    private final SceneDialog sceneDialog;
    private final SceneForecast sceneForecast;
    private final SceneJump sceneJump;
    ...
    private final onClickListener btnClickListener = id -> {
    ...
    private final Handler handler = new MessagHandler(new WeakReference<>(this));
    ...
    private static final class MessagHandler extends Handler {
        private final WeakReference<GameView> wk;
