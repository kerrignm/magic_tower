...
public class Game {
    ...
    private final GameControler mControler;
    ...
    public static void init(Context context, GameControler controler) {
        if (sInstance == null) {
    ...
    public boolean saveGame() {
        ...
        return FileUtil.writeInternal(mContext, "tower.json", JsonUtil.toJson(lvMap));
    }
